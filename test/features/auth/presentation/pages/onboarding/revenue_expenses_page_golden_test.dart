...
void main() {
  ...
  group('RevenueExpensesPage Golden Tests', () {
    testGoldens('RevenueExpensesPage - Empty State', (tester) async {
      ...
      await screenMatchesGolden(tester, 'revenue_expenses_page_empty');
    });
  });
}
